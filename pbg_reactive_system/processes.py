"""Bigraphical Reactive System engine.

A biology-agnostic Process that fires Milner-style reaction rules
(redex → reactum) on a time-stepped schedule. The matcher and
rewrite primitives come from ``bigraph_schema.assembly``; this
module only chooses *which* match to fire and *when*.
"""
import math
import random
