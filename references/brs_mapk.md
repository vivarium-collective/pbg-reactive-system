...
`pbg_reactive_system/composites.py`. It tracks the formalism
papers we build on and the experimental / structural references
for the biological system we encode.
